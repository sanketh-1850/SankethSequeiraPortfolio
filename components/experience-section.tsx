  ...
  const experiences = [
    {
      ...
      description: "Budget Request & Budget Development: Full-stack financial workflow and budget management platforms.",
      achievements: [
        "Built and hardened full-stack budgeting applications using React, Node.js, Express, Sequelize and MySQL to centralize funding requests, approvals, departmental budget planning and administration.",
        "Prevented stale financial changes from overwriting newer updates by implementing SHA-256 source snapshots, database row locking, conflict detection and atomic draft publishing.",
        "Engineered secure two-phase financial imports supporting up to 5,000 records per operation with server-side validation, single-use preview tokens, transactional commits and audit history.",
        "Automated fiscal-year budget and faculty-salary rollover with database coordination locks, idempotent retry handling, source-change detection, archival workflows and rollover lineage.",
        "Implemented production-grade authentication and authorization with UIC Shibboleth/SAML, MySQL-backed sessions, CSRF protection, hierarchical department access and RBAC across 27 permission actions.",
        "Designed crash-recoverable Box document management with idempotent uploads, compensating operations, reconciliation, structural file validation and ClamAV malware scanning.",
      ],
      technologies: [
        "React",
        "JavaScript",
